...
var _ImageKit_instances, _a, _ImageKit_encoder, _ImageKit_baseURLOverridden;
...
const custom_metadata_fields_1 = require("./resources/custom-metadata-fields.js");
const saved_extensions_1 = require("./resources/saved-extensions.js");
...
const files_1 = require("./resources/files/files.js");
const folders_1 = require("./resources/folders/folders.js");
...
class ImageKit {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('IMAGE_KIT_BASE_URL'), privateKey = (0, env_1.readEnv)('IMAGEKIT_PRIVATE_KEY'), password = (0, env_1.readEnv)('OPTIONAL_IMAGEKIT_IGNORES_THIS') ?? 'do_not_set', webhookSecret = (0, env_1.readEnv)('IMAGEKIT_WEBHOOK_SECRET') ?? null, ...opts } = {}) {
        _ImageKit_instances.add(this);
        _ImageKit_encoder.set(this, void 0);
        this.customMetadataFields = new API.CustomMetadataFields(this);
        this.files = new API.Files(this);
        this.savedExtensions = new API.SavedExtensions(this);
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('IMAGE_KIT_LOG'), "process.env['IMAGE_KIT_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _ImageKit_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _ImageKit_instances, "m", _ImageKit_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _ImageKit_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.ImageKit = ImageKit;
_a = ImageKit, _ImageKit_encoder = new WeakMap(), _ImageKit_instances = new WeakSet(), _ImageKit_baseURLOverridden = function _ImageKit_baseURLOverridden() {
    return this.baseURL !== 'https://api.imagekit.io';
};
ImageKit.ImageKit = _a;
ImageKit.DEFAULT_TIMEOUT = 60000; // 1 minute
ImageKit.ImageKitError = Errors.ImageKitError;
ImageKit.APIError = Errors.APIError;
ImageKit.APIConnectionError = Errors.APIConnectionError;
ImageKit.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
ImageKit.APIUserAbortError = Errors.APIUserAbortError;
ImageKit.NotFoundError = Errors.NotFoundError;
ImageKit.ConflictError = Errors.ConflictError;
ImageKit.RateLimitError = Errors.RateLimitError;
ImageKit.BadRequestError = Errors.BadRequestError;
ImageKit.AuthenticationError = Errors.AuthenticationError;
ImageKit.InternalServerError = Errors.InternalServerError;
ImageKit.PermissionDeniedError = Errors.PermissionDeniedError;
ImageKit.UnprocessableEntityError = Errors.UnprocessableEntityError;
ImageKit.toFile = Uploads.toFile;
ImageKit.CustomMetadataFields = custom_metadata_fields_1.CustomMetadataFields;
ImageKit.Files = files_1.Files;
ImageKit.SavedExtensions = saved_extensions_1.SavedExtensions;
ImageKit.Assets = assets_1.Assets;
ImageKit.Cache = cache_1.Cache;
ImageKit.Folders = folders_1.Folders;
ImageKit.Accounts = accounts_1.Accounts;
ImageKit.Beta = beta_1.Beta;
ImageKit.Webhooks = webhooks_1.Webhooks;
