...
class Files extends resource_1.APIResource {
    ...
    upload(body, options) {
        ...
        return this._client.post('/api/v2/files/upload', (0, uploads_1.multipartFormRequestOptions)({ body: serializedBody, defaultBaseURL: 'https://upload.imagekit.io', ...options }, this._client));
    }
}
exports.Files = Files;
