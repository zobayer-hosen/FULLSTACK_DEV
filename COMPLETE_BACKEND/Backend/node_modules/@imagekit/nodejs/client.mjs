...
import { CustomMetadataFields, } from "./resources/custom-metadata-fields.mjs";
import { SavedExtensions, } from "./resources/saved-extensions.mjs";
...
import { Files, } from "./resources/files/files.mjs";
import { Folders, } from "./resources/folders/folders.mjs";
...
export class ImageKit {
     ...
     */
    constructor({ baseURL = readEnv('IMAGE_KIT_BASE_URL'), privateKey = readEnv('IMAGEKIT_PRIVATE_KEY'), password = readEnv('OPTIONAL_IMAGEKIT_IGNORES_THIS') ?? 'do_not_set', webhookSecret = readEnv('IMAGEKIT_WEBHOOK_SECRET') ?? null, ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _ImageKit_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _ImageKit_instances, "m", _ImageKit_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _ImageKit_encoder, "f").call(this, { body, headers });
        }
    }
}
