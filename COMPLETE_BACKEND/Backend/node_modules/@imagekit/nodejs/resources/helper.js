...
class Helper extends resource_1.APIResource {
    ...
    buildSrc(opts) {
        ...
        const addAsQuery = transformation_utils_1.default.addAsQueryParameter(opts) || isSrcParameterUsedForURL;
        ...
        if (!isAbsoluteURL) {
            ...
            if (transformationString && transformationString.length && !addAsQuery) {
                pathParts.push(TRANSFORMATION_PARAMETER +
                    transformation_utils_1.default.getChainTransformDelimiter() +
